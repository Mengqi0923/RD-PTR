function [newChrom1, newv, IsChange] = UpdateTime_1(Chrom1, Chrom2, num_taxi, max_capacity, min_time, max_time, paretoset, v, w, c1, min_v, max_v,p1, IsChange, t_perenfence)
...
%     end
    ...
    newChrom1(i,:) = newChrom1(i,:) .* t_perenfence;
end
